...
action_3 (10) = happyShift action_13
...
happyReduction_7 (HappyTerminal (Digits happy_var_1))
	 =  HappyAbsSyn6
		 (Number happy_var_1
	)
...
happyReduction_8 (HappyTerminal (Digits happy_var_2))
	_
	 =  HappyAbsSyn6
		 (Number (- happy_var_2)
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	Digits happy_dollar_dollar -> cont 7;
	Symbol "+" -> cont 8;
	Symbol "-" -> cont 9;
	Symbol "*" -> cont 10;
	Symbol "/" -> cont 11;
